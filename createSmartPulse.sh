...
echo 'java -Xmx8g -Xms512M -jar "${SCRIPT_DIR}/plugins/org.eclipse.equinox.launcher_1.3.100.v20150511-1540.jar" -tc "${SCRIPT_DIR}/SmartPulse.xml" -s "${SCRIPT_DIR}/settings.epf" -i $@' >> "SmartPulse/SmartPulse.sh"
