...
contract AirBasicToken is StandardToken, BurnableToken, Ownable {
    // Constants
    string  public constant name = "Air Basic";
    string  public constant symbol = "ABTK";
    uint8   public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY      = 1282793976 * (10 ** uint256(decimals));
