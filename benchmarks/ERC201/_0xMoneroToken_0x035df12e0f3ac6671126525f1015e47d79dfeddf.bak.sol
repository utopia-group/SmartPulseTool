...
contract _0xMoneroToken is ERC20Interface, Owned {
    ...
    constructor() public onlyOwner{
        ...
        _totalSupply = 18400000 * 10**uint(18);
        ...
        function mint(uint256 nonce, bytes32 challenge_digest) public returns (bool success) {
      	    ...
      	    bytes32 challengeNumber = block.blockhash(block.number - 1);
