...
contract ULU is ERC20, ERC20Detailed {
    ...
    function addMinter(address _minter) public {
        require(msg.sender == governance, "!governance");
        // this function will be disabled after Friday, September 4, 2020 11:00:00 PM (GMT+0)
        require(block.timestamp < 1599217200);
        minters[_minter] = true;
    }

    function pendingAddMinter(address _minter) public {
        require(msg.sender == governance, "!governance");
        pendingAddMinters[_minter] = block.timestamp;
    }
    ...
    function executeAddMinter(address _minter) public {
        require(msg.sender == governance, "!governance");
        require(pendingAddMinters[_minter] != 0 && now > pendingAddMinters[_minter] + GRACE_PERIOD);
        minters[_minter] = true;
        pendingAddMinters[_minter] = 0;
    }
