//Address: 0x1877ef648d116De7889F84392d5c5F31f8A990a3
/**
...
contract AllowanceCrowdsale is Crowdsale {
    ...
    function _deliverTokens(address beneficiary, uint256 tokenAmount) internal {
        SafeERC20.safeTransferFrom(token(), _tokenWallet, beneficiary, tokenAmount);
    }
}
...
contract TimedCrowdsale is Crowdsale {
    ...
    function _extendTime(uint256 newClosingTime) internal {
        _extendTime_TimedCrowdsale(newClosingTime);
    }

    function _extendTime_TimedCrowdsale(uint256 newClosingTime) internal {
...
contract SmartexCrowdsale is Ownable, AllowanceCrowdsale, TimedCrowdsale {
  ...
  function _getTokenAmount(uint256 weiAmount) internal view returns (uint256) {
    ...
    return weiAmount * 157 / 1;
  }

  function _forwardFunds() internal {
    uint256 ownerPayment;
    uint256 walletsPayment;
    (ownerPayment, walletsPayment) = _splitPayment();
    ...
    if (walletsPayment > 0) {
      ...
      uint256 firstWalletPayment = walletsPayment / 2;
