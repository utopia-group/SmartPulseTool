...
contract APPCrowdsale is ReentrancyGuard {
     ...
     */
    constructor (uint256 rate, address payable wallet1, address payable wallet2, IERC20 token) public payable {
        require(rate > 0);
    ...
    function updateWallet(address payable newWallet1, address payable newWallet2) public {
        require(msg.sender == _owner);
