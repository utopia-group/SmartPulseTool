...
contract Melon is ERC20Burnable, ERC20Detailed {
    ...
    uint public constant BASE_UNITS = 1000000000000000000;
    uint public constant INFLATION_ENABLE_DATE = 1551398400;
    uint public constant INITIAL_TOTAL_SUPPLY = 9326130000000000000;
    uint public constant YEARLY_MINTABLE_AMOUNT = 3006000000000000000;
    uint public constant MINTING_INTERVAL = 31536000 seconds;
...
/*contract Deployer {
	Melon t;
	constructor() {
		t = new Melon("MelonToken", "MLN", 18, 0xDEADBEEF); 
	}
}*/
