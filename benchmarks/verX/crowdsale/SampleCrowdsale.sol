...
contract Deployer{
    SampleCrowdsaleToken token;
    SampleCrowdsale crowdsale;
    RefundEscrow escrow;
    ...
    constructor() public {
        ...
        token = new SampleCrowdsaleToken();
        crowdsale = new SampleCrowdsale(123123, 123123 + 1 weeks, 1, wallet, cap, token, goal);
        escrow = crowdsale._escrow();
