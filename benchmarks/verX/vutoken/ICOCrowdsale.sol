...
contract ICODeployer {
    ...
    constructor() public {
        v = new VUToken();
        w = new Whitelist();
        i = new ICOCrowdsale(v, address(w), address(0xdEaDbeEF11111111111111111111111111111111), address(0xDEadbeef22222222222222222222222222222222), 1525039200, 1530309600, 1530396000);
    }
}
