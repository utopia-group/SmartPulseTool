...
contract BasicToken is ERC20Basic {
  ...
  */
  function transfer(address _to, uint256 _value) public returns (bool) {
    return transfer_BasicToken(_to, _value);
  }

  function transfer_BasicToken(address _to, uint256 _value) internal returns (bool) {
...
contract StandardToken is ERC20, BasicToken {
  ...
  function transfer_StandardToken(address _to, uint256 _value) internal returns (bool) {
    return transfer_BasicToken(_to, _value);
  }
  ...
  function transferFrom(address _from, address _to, uint256 _value) public returns (bool) {
    return transferFrom_StandardToken(_from, _to, _value);
  }

  function transferFrom_StandardToken(address _from, address _to, uint256 _value) internal returns (bool) {
  ...
  function approve(address _spender, uint256 _value) public returns (bool) {
    return approve_StandardToken(_spender, _value);
  }

  function approve_StandardToken(address _spender, uint256 _value) internal returns (bool) {
...
contract GVToken is StandardToken {
    ...
    function transfer(address _to, uint _value) public returns (bool) {
        ...
        return transfer_StandardToken(_to, _value);
    }
...
contract GVOptionProgram {
    ...
    function executeOptions(address buyer, uint usdCents, string memory txHash) icoOnly
        ...
        (executedTokens, remainingCents) = executeIfAvailable(buyer, usdCents, txHash, gvOptionToken30, uint8(0), token30perCent);
        if (remainingCents == 0) {
            return (executedTokens, 0);
        }

        uint executed20;
        (executed20, remainingCents) = executeIfAvailable(buyer, remainingCents, txHash, gvOptionToken20, uint8(1), token20perCent);
        if (remainingCents == 0) {
            return (executedTokens + executed20, 0);
        }

        uint executed10;
        (executed10, remainingCents) = executeIfAvailable(buyer, remainingCents, txHash, gvOptionToken10, uint8(2), token10perCent);
    ...
    function buyOptions(address buyer, uint usdCents, string memory txHash) icoOnly public {
        ...
        uint256 remainUsdCents = buyIfAvailable(buyer, usdCents, txHash, gvOptionToken30, 0, option30perCent);
        if (remainUsdCents == 0) {
            return;
        }
