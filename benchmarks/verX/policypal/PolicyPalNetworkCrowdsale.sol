    ...
    */
        ...
        returns(uint256)
    {
        ...
        if (now >= increaseMaxContribTime) {
            ...
            userMaxContribution = maxContribution * 10;
        }
...
contract PolicyPalNetworkCrowdsale is CrowdsaleAuthorizer {
    ...
    */
        ...
        returns(uint256)
    {
        ...
        uint256 receivedTokens = weiContributionAllowed * 21000;
        ...
        if (receivedTokens > tokensRemaining) {
            ...
            weiContributionAllowed = tokensRemaining / 21000;
        }
        ...
        returns(bool)
    {
        ...
        if (address(_anyToken) != address(0x0)) {
            assert(_anyToken.transfer(multiSigWallet, _anyToken.balanceOf(address(this))));
        }
        return true;
    }
...
/*contract Deployer {
    constructor() public {
        PolicyPalNetworkCrowdsale p = new PolicyPalNetworkCrowdsale(address(0xabC1111111111111111111111111111111111111),
                                                                address(0xAbC2222222222222222222222222222222222222),
