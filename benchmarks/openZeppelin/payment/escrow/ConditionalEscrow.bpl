...
// Command Line Options: /pretty:1 /print:ConditionalEscrow.bpl /noVerify __SolToBoogieTest_out.bpl
...
procedure {:inline 1} ConditionalEscrow_ConditionalEscrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int, __tmp__Length, __tmp__now, __tmp___deposits_Escrow, __tmp___primary_Secondary, gas, _primary_Secondary, _deposits_Escrow, M_Ref_int, Alloc;
...
procedure {:public} {:inline 1} withdrawalAllowed_ConditionalEscrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s11: Ref)
   returns (__ret_0_: bool);



procedure {:public} {:inline 1} withdraw_ConditionalEscrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s28: Ref);
...
implementation withdraw_ConditionalEscrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s28: Ref)
{
  var __exception: bool;
    ...
    if (__exception)
    {
        ...
        __tmp___deposits_Escrow := _deposits_Escrow;
        __tmp___primary_Secondary := _primary_Secondary;
        call withdraw_ConditionalEscrow__fail(this, msgsender_MSG, msgvalue_MSG, payee_s28);
        assume revert || gas < 0;
    }
    else
    {
        call withdraw_ConditionalEscrow__success(this, msgsender_MSG, msgvalue_MSG, payee_s28);
        assume !revert && gas >= 0;
    }
}
...
procedure {:public} {:inline 1} depositsOf_Escrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s66: Ref)
...
implementation depositsOf_Escrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s66: Ref)
   returns (__ret_0_: int)
{
  var __exception: bool;
    ...
    if (__exception)
    {
        ...
        __tmp___deposits_Escrow := _deposits_Escrow;
        __tmp___primary_Secondary := _primary_Secondary;
        call __ret_0_ := depositsOf_Escrow__fail(this, msgsender_MSG, msgvalue_MSG, payee_s66);
        assume revert || gas < 0;
    }
    else
    {
        call __ret_0_ := depositsOf_Escrow__success(this, msgsender_MSG, msgvalue_MSG, payee_s66);
        assume !revert && gas >= 0;
    }
}
...
procedure {:public} {:inline 1} deposit_Escrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s76: Ref);
...
implementation deposit_Escrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s76: Ref)
{
  var __exception: bool;
    ...
    if (__exception)
    {
        ...
        __tmp___deposits_Escrow := _deposits_Escrow;
        __tmp___primary_Secondary := _primary_Secondary;
        call deposit_Escrow__fail(this, msgsender_MSG, msgvalue_MSG, payee_s76);
        assume revert || gas < 0;
    }
    else
    {
        call deposit_Escrow__success(this, msgsender_MSG, msgvalue_MSG, payee_s76);
        assume !revert && gas >= 0;
    }
}
...
procedure {:inline 1} deposit_Escrow_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s105: Ref);
  modifies gas, M_Ref_int, revert;



procedure {:public} {:inline 1} withdraw_Escrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s115: Ref);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int, __tmp__Length, __tmp__now, __tmp___deposits_Escrow, __tmp___primary_Secondary, gas, M_Ref_int, Balance;



implementation withdraw_Escrow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s115: Ref)
{
  var __exception: bool;
    ...
    if (__exception)
    {
        ...
        __tmp___deposits_Escrow := _deposits_Escrow;
        __tmp___primary_Secondary := _primary_Secondary;
        call withdraw_Escrow__fail(this, msgsender_MSG, msgvalue_MSG, payee_s115);
        assume revert || gas < 0;
    }
    else
    {
        call withdraw_Escrow__success(this, msgsender_MSG, msgvalue_MSG, payee_s115);
        assume !revert && gas >= 0;
    }
}
...
procedure {:inline 1} withdraw_Escrow_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s146: Ref);
...
procedure {:inline 1} add_SafeMath__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, a_s174: int, b_s174: int)
   returns (__ret_0_: int);
  modifies gas, revert;



procedure {:inline 1} sub_SafeMath__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, a_s199: int, b_s199: int)
   returns (__ret_0_: int);
  modifies revert;
...
procedure {:public} {:inline 1} transferPrimary_Secondary(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, recipient_s353: Ref);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int, __tmp__Length, __tmp__now, __tmp___deposits_Escrow, __tmp___primary_Secondary, gas, _primary_Secondary;



implementation transferPrimary_Secondary(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, recipient_s353: Ref)
{
  var __exception: bool;
    ...
    if (__exception)
    {
        ...
        __tmp___deposits_Escrow := _deposits_Escrow;
        __tmp___primary_Secondary := _primary_Secondary;
        call transferPrimary_Secondary__fail(this, msgsender_MSG, msgvalue_MSG, recipient_s353);
        assume revert || gas < 0;
    }
    else
    {
        call transferPrimary_Secondary__success(this, msgsender_MSG, msgvalue_MSG, recipient_s353);
        assume !revert && gas >= 0;
    }
}
...
procedure main();
  modifies gas, now, revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int, __tmp__Length, __tmp__now, __tmp___deposits_Escrow, __tmp___primary_Secondary, _primary_Secondary, Balance, _deposits_Escrow, M_Ref_int, Alloc;
...
procedure {:inline 1} withdraw_ConditionalEscrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s28: Ref);
  modifies revert, gas, M_Ref_int, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int, __tmp__Length, __tmp__now, __tmp___deposits_Escrow, __tmp___primary_Secondary, Balance;



procedure {:inline 1} withdraw_ConditionalEscrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s28: Ref);
  modifies revert, gas, __tmp__M_Ref_int, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__Length, __tmp__now, __tmp___deposits_Escrow, __tmp___primary_Secondary;
...
procedure {:inline 1} depositsOf_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s66: Ref)
   returns (__ret_0_: int);
  modifies gas;



procedure {:inline 1} depositsOf_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s66: Ref)
   returns (__ret_0_: int);
  modifies gas;



procedure {:inline 1} deposit_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s76: Ref);
  modifies Balance, gas, M_Ref_int, revert;



procedure {:inline 1} deposit_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s76: Ref);
  modifies __tmp__Balance, gas, __tmp__M_Ref_int, revert;



procedure {:inline 1} deposit_Escrow_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s105: Ref);
  modifies gas, __tmp__M_Ref_int, revert;



procedure {:inline 1} withdraw_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s115: Ref);
  modifies gas, M_Ref_int, revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int, __tmp__Length, __tmp__now, __tmp___deposits_Escrow, __tmp___primary_Secondary, Balance;



procedure {:inline 1} withdraw_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s115: Ref);
...
procedure {:inline 1} withdraw_Escrow_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s146: Ref);
  modifies gas, __tmp__M_Ref_int, revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__Length, __tmp__now, __tmp___deposits_Escrow, __tmp___primary_Secondary;
...
procedure {:inline 1} add_SafeMath__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, a_s174: int, b_s174: int)
   returns (__ret_0_: int);
  modifies gas, revert;



procedure {:inline 1} sub_SafeMath__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, a_s199: int, b_s199: int)
   returns (__ret_0_: int);
  modifies revert;
...
procedure {:inline 1} transferPrimary_Secondary__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, recipient_s353: Ref);
  modifies gas, revert, _primary_Secondary;



procedure {:inline 1} transferPrimary_Secondary__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, recipient_s353: Ref);
...
implementation withdraw_ConditionalEscrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s28: Ref)
{
  var __var_1: bool;

    call __var_1 := withdrawalAllowed_ConditionalEscrow(this, msgsender_MSG, msgvalue_MSG, payee_s28);
    if (!__var_1)
    {
        revert := true;
        return;
    ...
    if (__tmp__DType[this] == ConditionalEscrow)
    {
        call withdraw_Escrow_Escrow__fail(this, msgsender_MSG, msgvalue_MSG, payee_s28);
        if (revert)
        {
            return;
        }
...
implementation withdraw_ConditionalEscrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s28: Ref)
{
  var __var_1: bool;
    ...
    if (DType[this] == ConditionalEscrow)
    {
        call withdraw_Escrow_Escrow__success(this, msgsender_MSG, msgvalue_MSG, payee_s28);
        if (revert)
        {
            return;
        }
...
implementation depositsOf_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s66: Ref)
   returns (__ret_0_: int)
{
    gas := gas - 3;
    gas := gas - 304;
    assume __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s66] >= 0;
    __ret_0_ := __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s66];
    return;
}



implementation depositsOf_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s66: Ref)
   returns (__ret_0_: int)
{
    gas := gas - 3;
    gas := gas - 304;
    assume M_Ref_int[_deposits_Escrow[this]][payee_s66] >= 0;
    __ret_0_ := M_Ref_int[_deposits_Escrow[this]][payee_s66];
    return;
}



implementation deposit_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s76: Ref)
{
    ...
    if (__tmp__DType[this] == ConditionalEscrow)
    {
        call deposit_Escrow_Escrow__fail(this, msgsender_MSG, msgvalue_MSG, payee_s76);
        if (revert)
        {
            return;
        }
...
implementation deposit_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s76: Ref)
{
    ...
    if (DType[this] == ConditionalEscrow)
    {
        call deposit_Escrow_Escrow__success(this, msgsender_MSG, msgvalue_MSG, payee_s76);
        if (revert)
        {
            return;
        }
...
implementation deposit_Escrow_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s105: Ref)
{
  var amount_s104: int;
  var __var_3: int;
    ...
    amount_s104 := msgvalue_MSG;
    gas := gas - 20439;
    assume __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s105] >= 0;
    assume __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s105] >= 0;
    assume amount_s104 >= 0;
    call __var_3 := add_SafeMath__fail(this, this, 0, __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s105], amount_s104);
    if (revert)
    {
        return;
    }

    __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s105] := __var_3;
    assume __var_3 >= 0;
}



implementation deposit_Escrow_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s105: Ref)
{
  var amount_s104: int;
  var __var_3: int;
    ...
    amount_s104 := msgvalue_MSG;
    gas := gas - 20439;
    assume M_Ref_int[_deposits_Escrow[this]][payee_s105] >= 0;
    assume M_Ref_int[_deposits_Escrow[this]][payee_s105] >= 0;
    assume amount_s104 >= 0;
    call __var_3 := add_SafeMath__success(this, this, 0, M_Ref_int[_deposits_Escrow[this]][payee_s105], amount_s104);
    if (revert)
    {
        return;
    }

    M_Ref_int[_deposits_Escrow[this]][payee_s105] := __var_3;
    assume __var_3 >= 0;
...
implementation withdraw_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s115: Ref)
{
    gas := gas - 7;
    if (__tmp__DType[this] == ConditionalEscrow)
    {
        call withdraw_Escrow_Escrow__fail(this, msgsender_MSG, msgvalue_MSG, payee_s115);
        if (revert)
        {
            return;
        }
...
implementation withdraw_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s115: Ref)
{
    gas := gas - 7;
    if (DType[this] == ConditionalEscrow)
    {
        call withdraw_Escrow_Escrow__success(this, msgsender_MSG, msgvalue_MSG, payee_s115);
        if (revert)
        {
            return;
        }
...
implementation withdraw_Escrow_Escrow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s146: Ref)
{
  var payment_s145: int;
  var __var_4: int;
  var __var_5: bool;
    ...
    gas := gas - 307;
    assume payment_s145 >= 0;
    assume __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s146] >= 0;
    payment_s145 := __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s146];
    gas := gas - 5104;
    assume __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s146] >= 0;
    __tmp__M_Ref_int[__tmp___deposits_Escrow[this]][payee_s146] := 0;
    gas := gas - 35787;
    __var_4 := gas;
    if (gas > 2300)
    {
    ...
    __var_4 := __var_4 - gas;
    assume payment_s145 >= 0;
    call __var_5 := send__fail(this, payee_s146, payment_s145);
    if (!__var_5)
    {
        revert := true;
        return;
...
implementation withdraw_Escrow_Escrow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, payee_s146: Ref)
{
  var payment_s145: int;
  var __var_4: int;
  var __var_5: bool;
    ...
    gas := gas - 307;
    assume payment_s145 >= 0;
    assume M_Ref_int[_deposits_Escrow[this]][payee_s146] >= 0;
    payment_s145 := M_Ref_int[_deposits_Escrow[this]][payee_s146];
    gas := gas - 5104;
    assume M_Ref_int[_deposits_Escrow[this]][payee_s146] >= 0;
    M_Ref_int[_deposits_Escrow[this]][payee_s146] := 0;
    gas := gas - 35787;
    __var_4 := gas;
    if (gas > 2300)
    {
    ...
    __var_4 := __var_4 - gas;
    assume payment_s145 >= 0;
    call __var_5 := send__success(this, payee_s146, payment_s145);
    if (!__var_5)
    {
        revert := true;
        return;
...
implementation add_SafeMath__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, a_s174: int, b_s174: int)
   returns (__ret_0_: int)
{
  var c_s173: int;
    ...
    assume a_s174 >= 0;
    assume b_s174 >= 0;
    assume a_s174 + b_s174 >= 0;
    c_s173 := a_s174 + b_s174;
    gas := gas - 664;
    assume c_s173 >= 0;
    assume a_s174 >= 0;
    if (!(c_s173 >= a_s174))
...
implementation add_SafeMath__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, a_s174: int, b_s174: int)
   returns (__ret_0_: int)
{
  var c_s173: int;
...
implementation sub_SafeMath__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, a_s199: int, b_s199: int)
   returns (__ret_0_: int)
{
  var c_s198: int;
    ...
    assume a_s199 >= 0;
    assume b_s199 >= 0;
    assume a_s199 - b_s199 >= 0;
    c_s198 := a_s199 - b_s199;
    assume c_s198 >= 0;
    __ret_0_ := c_s198;
    return;
}
...
implementation sub_SafeMath__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, a_s199: int, b_s199: int)
   returns (__ret_0_: int)
{
  var c_s198: int;
...
{
  var msgSender_s307: Ref;

    assume msgsender_MSG != null;
    __tmp___primary_Secondary[this] := null;
    if (__tmp__DType[this] == ConditionalEscrow)
    {
        call msgSender_s307 := _msgSender_Context__fail(this, msgsender_MSG, msgvalue_MSG);
        if (revert)
        {
            return;
        }
    ...
    msgSender_s307 := msgSender_s307;
    __tmp___primary_Secondary[this] := msgSender_s307;
}
...
implementation Secondary_Secondary_NoBaseCtor__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  var msgSender_s307: Ref;
    ...
    if (DType[this] == ConditionalEscrow)
    {
        call msgSender_s307 := _msgSender_Context__success(this, msgsender_MSG, msgvalue_MSG);
        if (revert)
        {
            return;
        }
    ...
    msgSender_s307 := msgSender_s307;
    _primary_Secondary[this] := msgSender_s307;
...
implementation transferPrimary_Secondary__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, recipient_s353: Ref)
{
  var __var_7: Ref;
    ...
    gas := gas - 20267;
    __tmp___primary_Secondary[this] := recipient_s353;
}



implementation transferPrimary_Secondary__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, recipient_s353: Ref)
{
  var __var_7: Ref;
    ...
    gas := gas - 20267;
    _primary_Secondary[this] := recipient_s353;
    assert {:EventEmitted "PrimaryTransferred_Secondary"} true;
}
...
implementation onlyPrimary_pre__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  var __var_6: Ref;
    ...
    if (!(__var_6 == __tmp___primary_Secondary[this]))
    {
        revert := true;
        return;
    }
...
implementation onlyPrimary_pre__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  var __var_6: Ref;
    ...
    if (!(__var_6 == _primary_Secondary[this]))
    {
        revert := true;
        return;
    }
...
implementation CorralChoice_ConditionalEscrow(this: Ref)
{
  ...
  var tmpNow: int;
    ...
    {
        gas := gas - 21000;
        call transferPrimary_Secondary(this, msgsender_MSG, msgvalue_MSG, recipient_s353);
    }
    else if (choice == 4)
    {
        gas := gas - 21000;
        call __ret_0_depositsOf := depositsOf_Escrow(this, msgsender_MSG, msgvalue_MSG, payee_s66);
    }
    else if (choice == 3)
    {
        gas := gas - 21000;
        call deposit_Escrow(this, msgsender_MSG, msgvalue_MSG, payee_s76);
    }
    else if (choice == 2)
    {
        gas := gas - 21000;
        call withdraw_ConditionalEscrow(this, msgsender_MSG, msgvalue_MSG, payee_s28);
    }
    else if (choice == 1)
    {
        gas := gas - 21000;
        call __ret_0_withdrawalAllowed := withdrawalAllowed_ConditionalEscrow(this, msgsender_MSG, msgvalue_MSG, payee_s11);
    }
}
...
implementation CorralChoice_Escrow(this: Ref)
{
  ...
  var tmpNow: int;
    ...
    {
        gas := gas - 21000;
        call withdraw_Escrow(this, msgsender_MSG, msgvalue_MSG, payee_s115);
    }
}
...
implementation CorralEntry_Escrow()
{
  ...
  var msgvalue_MSG: int;
    ...
    assume now >= 0;
    assume DType[this] == ConditionalEscrow || DType[this] == Escrow;
    gas := gas - 53000;
    call Escrow_Escrow__success(this, msgsender_MSG, msgvalue_MSG);
    assume !revert && gas >= 0;
    while (true)
