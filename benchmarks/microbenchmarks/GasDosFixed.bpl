...
// Command Line Options: /print:GasDosFixed.bpl /pretty:1 /noVerify __SolToBoogieTest_out.bpl

// LTLVariables: user:Ref
// LTLFairness: <>(finished(CrowdFund.close)) && [](<>(started(CrowdFund.refund, msg.sender == user && Balance[this] >= fsum(CrowdFund.buy, 2, msg.sender == user)))) && [](!reverted(send(from, to, amt), __tmp__Balance[from] >= amt && success == false)) && [](!finished(send(from, to, amt), Balance[from] >= amt && success == false)) 
...
// LTLVariables: user:Ref
// LTLFairness: <>(started(CrowdFund.refund, msg.sender == user && this.refundAmount[user] > 0 && this.closed == true && Balance[this] >= fsum(CrowdFund.buy, 2, msg.sender == user))) && [](!reverted(send(from, to, amt), __tmp__Balance[from] >= amt && success == false) && !finished(send(from, to, amt), Balance[from] >= amt && success == false))
// LTLProperty: <>(finished(send(from, to, amt), success == true && to == user && amt == fsum(CrowdFund.buy, 2, msg.sender == user)))

// LTLVariables: user:Ref
// LTLFairness: <>(finished(CrowdFund.close)) && [](<>(started(CrowdFund.refund, msg.sender == user)))
...
procedure {:inline 1} CrowdFund_CrowdFund_NoBaseCtor__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies Balance, refundAmount_CrowdFund, M_Ref_int_refundAmount0, sum_refundAmount0, closed_CrowdFund, Alloc;



procedure {:inline 1} CrowdFund_CrowdFund(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, Balance, refundAmount_CrowdFund, M_Ref_int_refundAmount0, sum_refundAmount0, closed_CrowdFund, Alloc;
...
procedure {:public} {:inline 1} buy_CrowdFund(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, gas, Balance, sum_refundAmount0, M_Ref_int_refundAmount0;
...
procedure {:public} {:inline 1} close_CrowdFund(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, gas, closed_CrowdFund;
...
procedure {:public} {:inline 1} refund_CrowdFund(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, gas, sum_refundAmount0, M_Ref_int_refundAmount0, Balance, closed_CrowdFund;
...
procedure {:inline 1} FallbackDispatch__success(from: Ref, to: Ref, amount: int);
  modifies Balance, revert, gas, sum_refundAmount0, M_Ref_int_refundAmount0, closed_CrowdFund, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund;
...
procedure {:inline 1} send__success(from: Ref, to: Ref, amount: int) returns (success: bool);
  modifies __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, revert, gas, Balance, sum_refundAmount0, M_Ref_int_refundAmount0, closed_CrowdFund;



procedure CorralChoice_CrowdFund(this: Ref);
  modifies gas, now, Alloc, revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, Balance, sum_refundAmount0, M_Ref_int_refundAmount0, closed_CrowdFund;



procedure main();
  modifies gas, Alloc, Balance, refundAmount_CrowdFund, M_Ref_int_refundAmount0, sum_refundAmount0, closed_CrowdFund, now, revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund;
...
procedure {:inline 1} CrowdFund_CrowdFund_NoBaseCtor__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies __tmp__Balance, __tmp__refundAmount_CrowdFund, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__closed_CrowdFund, __tmp__Alloc;
...
procedure {:inline 1} buy_CrowdFund__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies Balance, gas, revert, sum_refundAmount0, M_Ref_int_refundAmount0;



procedure {:inline 1} buy_CrowdFund__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies __tmp__Balance, gas, revert, __tmp__sum_refundAmount0, __tmp__M_Ref_int_refundAmount0;
...
procedure {:inline 1} refund_CrowdFund__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies gas, revert, sum_refundAmount0, M_Ref_int_refundAmount0, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, Balance, closed_CrowdFund;



procedure {:inline 1} refund_CrowdFund__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies gas, revert, __tmp__sum_refundAmount0, __tmp__M_Ref_int_refundAmount0, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund;



procedure {:inline 1} FallbackDispatch__fail(from: Ref, to: Ref, amount: int);
  modifies __tmp__Balance, revert, gas, __tmp__sum_refundAmount0, __tmp__M_Ref_int_refundAmount0, __tmp__closed_CrowdFund, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund;
...
procedure {:inline 1} send__fail(from: Ref, to: Ref, amount: int) returns (success: bool);
  modifies __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__Length, __tmp__now, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, revert, gas;
...
implementation CrowdFund_CrowdFund_NoBaseCtor__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  var __var_1: Ref;
    ...
    __tmp__refundAmount_CrowdFund[this] := __var_1;
...
implementation CrowdFund_CrowdFund_NoBaseCtor__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  var __var_1: Ref;
    ...
    refundAmount_CrowdFund[this] := __var_1;
...
implementation refund_CrowdFund__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  var __var_3: bool;
    ...
    assume __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][msgsender_MSG]
       >= 0;
    refund_s74 := __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][msgsender_MSG];
    gas := gas - 5103;
    assume __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][msgsender_MSG]
       >= 0;
    __tmp__sum_refundAmount0[__tmp__refundAmount_CrowdFund[this]] := __tmp__sum_refundAmount0[__tmp__refundAmount_CrowdFund[this]]
       - __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][msgsender_MSG];
    __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][msgsender_MSG] := 0;
    __tmp__sum_refundAmount0[__tmp__refundAmount_CrowdFund[this]] := __tmp__sum_refundAmount0[__tmp__refundAmount_CrowdFund[this]]
       + __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][msgsender_MSG];
    gas := gas - 35786;
    __var_2 := gas;
    ...
    __var_2 := __var_2 - gas;
    assume refund_s74 >= 0;
    call __var_3 := send__fail(this, msgsender_MSG, refund_s74);
    if (!__var_3)
    {
        revert := true;
        return;
...
implementation refund_CrowdFund__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  var __var_3: bool;
    ...
    assume refund_s74 >= 0;
    assume M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][msgsender_MSG] >= 0;
    refund_s74 := M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][msgsender_MSG];
    gas := gas - 5103;
    assume M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][msgsender_MSG] >= 0;
    sum_refundAmount0[refundAmount_CrowdFund[this]] := sum_refundAmount0[refundAmount_CrowdFund[this]]
       - M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][msgsender_MSG];
    M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][msgsender_MSG] := 0;
    sum_refundAmount0[refundAmount_CrowdFund[this]] := sum_refundAmount0[refundAmount_CrowdFund[this]]
       + M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][msgsender_MSG];
    gas := gas - 35786;
    __var_2 := gas;
    ...
    __var_2 := __var_2 - gas;
    assume refund_s74 >= 0;
    call __var_3 := send__success(this, msgsender_MSG, refund_s74);
    if (!__var_3)
    {
        revert := true;
        return;
