...
procedure {:public} {:inline 1} balanceOf_Overflow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s65: Ref) returns (__ret_0_: int);
modifies revert;
modifies __tmp__Balance;
modifies __tmp__DType;
modifies __tmp__Alloc;
...
modifies __tmp__balances_Overflow;
modifies gas;
implementation balanceOf_Overflow(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s65: Ref) returns (__ret_0_: int)
{
var __exception: bool;
havoc __exception;
revert := false;
...
__tmp__now := now;
__tmp__balances_Overflow := balances_Overflow;
call __ret_0_ := balanceOf_Overflow__fail(this, msgsender_MSG, msgvalue_MSG, user_s65);
assume ((revert) || ((gas) < (0)));
} else {
call __ret_0_ := balanceOf_Overflow__success(this, msgsender_MSG, msgvalue_MSG, user_s65);
assume ((!(revert)) && ((gas) >= (0)));
}
}
...
modifies __tmp__now;
modifies __tmp__balances_Overflow;
procedure {:inline 1} balanceOf_Overflow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s65: Ref) returns (__ret_0_: int);
modifies gas;
procedure {:inline 1} balanceOf_Overflow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s65: Ref) returns (__ret_0_: int);
modifies gas;
...
__tmp__M_Ref_int_balances0[__tmp__balances_Overflow[this]][msgsender_MSG] := ((__tmp__M_Ref_int_balances0[__tmp__balances_Overflow[this]][msgsender_MSG]) + ((msgvalue_MSG) % (256))) % (256);
__tmp__sum_balances0[__tmp__balances_Overflow[this]] := (__tmp__sum_balances0[__tmp__balances_Overflow[this]]) + (__tmp__M_Ref_int_balances0[__tmp__balances_Overflow[this]][msgsender_MSG]);
}
...
M_Ref_int_balances0[balances_Overflow[this]][msgsender_MSG] := ((M_Ref_int_balances0[balances_Overflow[this]][msgsender_MSG]) + ((msgvalue_MSG) % (256))) % (256);
sum_balances0[balances_Overflow[this]] := (sum_balances0[balances_Overflow[this]]) + (M_Ref_int_balances0[balances_Overflow[this]][msgsender_MSG]);
}
...
__var_3 := (__var_3) - (gas);
call __var_4 := send__fail(this, msgsender_MSG, __tmp__M_Ref_int_balances0[__tmp__balances_Overflow[this]][msgsender_MSG]);
if (!(__var_4)) {
revert := true;
return;
}
...
__var_3 := (__var_3) - (gas);
call __var_4 := send__success(this, msgsender_MSG, M_Ref_int_balances0[balances_Overflow[this]][msgsender_MSG]);
if (!(__var_4)) {
revert := true;
return;
}
...
implementation balanceOf_Overflow__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s65: Ref) returns (__ret_0_: int)
{
gas := (gas) - (3);
gas := (gas) - (346);
__ret_0_ := __tmp__M_Ref_int_balances0[__tmp__balances_Overflow[this]][user_s65];
return;
}

implementation balanceOf_Overflow__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s65: Ref) returns (__ret_0_: int)
{
gas := (gas) - (3);
gas := (gas) - (346);
__ret_0_ := M_Ref_int_balances0[balances_Overflow[this]][user_s65];
return;
}
...
if ((gas) >= (0)) {
assume ((msgvalue_MSG) == (0));
call __ret_0_balanceOf := balanceOf_Overflow__fail(from, to, msgvalue_MSG, user_s65);
if (revert) {
return;
}
}
...
if ((gas) >= (0)) {
assume ((msgvalue_MSG) == (0));
call __ret_0_balanceOf := balanceOf_Overflow__success(from, to, msgvalue_MSG, user_s65);
if (revert) {
return;
}
}
...
if ((gas) >= (0)) {
assume ((msgvalue_MSG) == (0));
call __ret_0_balanceOf := balanceOf_Overflow(this, msgsender_MSG, msgvalue_MSG, user_s65);
}
}
}
