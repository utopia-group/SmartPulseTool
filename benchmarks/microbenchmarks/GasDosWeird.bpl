...
// LTLFairness: <>(finished(CrowdFund.close)) && [](<>(started(CrowdFund.refund, msg.sender == user && Balance[this] >= fsum(CrowdFund.buy, 2, msg.sender == user))))
...
// #LTLVariables: user:Ref
// #LTLFariness: finished(Crowdfund.buy, msg.sender == user) ; finished(Crowdfund.close) ; started(Crowdfund.refund, msg.sender == user)
// #LTLProperty: <>(finished(Crowdfund.refund, msg.sender == user))
...
procedure {:inline 1} send__success(from: Ref, to: Ref, amount: int) returns (success: bool);
  modifies __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__M_int_Ref, __tmp__sum, __tmp__Length, __tmp__now, __tmp__refundAddresses_CrowdFund, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, revert, Balance;
...
procedure {:inline 1} send__fail(from: Ref, to: Ref, amount: int) returns (success: bool);
  modifies __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_refundAmount0, __tmp__sum_refundAmount0, __tmp__M_int_Ref, __tmp__sum, __tmp__Length, __tmp__now, __tmp__refundAddresses_CrowdFund, __tmp__refundAmount_CrowdFund, __tmp__closed_CrowdFund, revert;
