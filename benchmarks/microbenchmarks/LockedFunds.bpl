...
// Command Line Options: /print:LockedFunds.bpl /pretty:1 /noVerify __SolToBoogieTest_out.bpl
...
procedure {:public} {:inline 1} transfer_Wallet(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, to_s75: Ref, amt_s75: int);
...
implementation transfer_Wallet(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, to_s75: Ref, amt_s75: int)
{
  var __exception: bool;
    ...
    if (__exception)
    {
        ...
        __tmp__now := now;
        __tmp__balance_Wallet := balance_Wallet;
        call transfer_Wallet__fail(this, msgsender_MSG, msgvalue_MSG, to_s75, amt_s75);
        assume revert || gas < 0;
    }
    else
    {
        call transfer_Wallet__success(this, msgsender_MSG, msgvalue_MSG, to_s75, amt_s75);
        assume !revert && gas >= 0;
    }
}
...
procedure {:public} {:inline 1} balanceOf_Wallet(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s87: Ref)
...
implementation balanceOf_Wallet(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s87: Ref)
   returns (__ret_0_: int)
{
  var __exception: bool;
    ...
    if (__exception)
    {
        ...
        __tmp__now := now;
        __tmp__balance_Wallet := balance_Wallet;
        call __ret_0_ := balanceOf_Wallet__fail(this, msgsender_MSG, msgvalue_MSG, user_s87);
        assume revert || gas < 0;
    }
    else
    {
        call __ret_0_ := balanceOf_Wallet__success(this, msgsender_MSG, msgvalue_MSG, user_s87);
        assume !revert && gas >= 0;
    }
}
...
procedure {:inline 1} transfer_Wallet__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, to_s75: Ref, amt_s75: int);
  modifies gas, sum_balance0, M_Ref_int_balance0;



procedure {:inline 1} transfer_Wallet__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, to_s75: Ref, amt_s75: int);
  modifies gas, __tmp__sum_balance0, __tmp__M_Ref_int_balance0;



procedure {:inline 1} balanceOf_Wallet__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s87: Ref)
   returns (__ret_0_: int);
  modifies gas;



procedure {:inline 1} balanceOf_Wallet__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s87: Ref)
   returns (__ret_0_: int);
  modifies gas;
...
implementation transfer_Wallet__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, to_s75: Ref, amt_s75: int)
{
    gas := gas - 304;
    assume __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][msgsender_MSG] >= 0;
    assume amt_s75 >= 0;
    if (__tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][msgsender_MSG] >= amt_s75)
    {
        gas := gas - 20328;
        assume __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][msgsender_MSG] >= 0;
        assume amt_s75 >= 0;
        __tmp__sum_balance0[__tmp__balance_Wallet[this]] := __tmp__sum_balance0[__tmp__balance_Wallet[this]]
           - __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][msgsender_MSG];
        __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][msgsender_MSG] := __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][msgsender_MSG] - amt_s75;
        __tmp__sum_balance0[__tmp__balance_Wallet[this]] := __tmp__sum_balance0[__tmp__balance_Wallet[this]]
           + __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][msgsender_MSG];
        gas := gas - 20323;
        assume __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][to_s75] >= 0;
        assume amt_s75 >= 0;
        __tmp__sum_balance0[__tmp__balance_Wallet[this]] := __tmp__sum_balance0[__tmp__balance_Wallet[this]]
           - __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][to_s75];
        __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][to_s75] := __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][to_s75] + amt_s75;
        __tmp__sum_balance0[__tmp__balance_Wallet[this]] := __tmp__sum_balance0[__tmp__balance_Wallet[this]]
           + __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][to_s75];
    }
}
...
implementation transfer_Wallet__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, to_s75: Ref, amt_s75: int)
{
    gas := gas - 304;
    assume M_Ref_int_balance0[balance_Wallet[this]][msgsender_MSG] >= 0;
    assume amt_s75 >= 0;
    if (M_Ref_int_balance0[balance_Wallet[this]][msgsender_MSG] >= amt_s75)
    {
        gas := gas - 20328;
        assume M_Ref_int_balance0[balance_Wallet[this]][msgsender_MSG] >= 0;
        assume amt_s75 >= 0;
        sum_balance0[balance_Wallet[this]] := sum_balance0[balance_Wallet[this]]
           - M_Ref_int_balance0[balance_Wallet[this]][msgsender_MSG];
        M_Ref_int_balance0[balance_Wallet[this]][msgsender_MSG] := M_Ref_int_balance0[balance_Wallet[this]][msgsender_MSG] - amt_s75;
        sum_balance0[balance_Wallet[this]] := sum_balance0[balance_Wallet[this]]
           + M_Ref_int_balance0[balance_Wallet[this]][msgsender_MSG];
        gas := gas - 20323;
        assume M_Ref_int_balance0[balance_Wallet[this]][to_s75] >= 0;
        assume amt_s75 >= 0;
        sum_balance0[balance_Wallet[this]] := sum_balance0[balance_Wallet[this]]
           - M_Ref_int_balance0[balance_Wallet[this]][to_s75];
        M_Ref_int_balance0[balance_Wallet[this]][to_s75] := M_Ref_int_balance0[balance_Wallet[this]][to_s75] + amt_s75;
        sum_balance0[balance_Wallet[this]] := sum_balance0[balance_Wallet[this]]
           + M_Ref_int_balance0[balance_Wallet[this]][to_s75];
    }
}
...
implementation balanceOf_Wallet__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s87: Ref)
   returns (__ret_0_: int)
{
    gas := gas - 3;
    gas := gas - 304;
    assume __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][user_s87] >= 0;
    __ret_0_ := __tmp__M_Ref_int_balance0[__tmp__balance_Wallet[this]][user_s87];
    return;
}



implementation balanceOf_Wallet__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, user_s87: Ref)
   returns (__ret_0_: int)
{
    gas := gas - 3;
    gas := gas - 304;
    assume M_Ref_int_balance0[balance_Wallet[this]][user_s87] >= 0;
    __ret_0_ := M_Ref_int_balance0[balance_Wallet[this]][user_s87];
    return;
}
    ...
    while (iterate && gas >= 21000)
    {
        ...
        if (__tmp__DType[from] == Wallet)
        {
            ...
            else if (choice == 2)
            {
                ...
                {
                    assume msgvalue_MSG == 0;
                    call transfer_Wallet__fail(from, to, msgvalue_MSG, to_s75, amt_s75);
                    if (revert)
                    {
                        return;
                    }
            ...
            else if (choice == 1)
            {
                ...
                {
                    assume msgvalue_MSG == 0;
                    call __ret_0_balanceOf := balanceOf_Wallet__fail(from, to, msgvalue_MSG, user_s87);
                    if (revert)
                    {
                        return;
                    }
    ...
    while (iterate && gas >= 21000)
    {
        ...
        if (DType[from] == Wallet)
        {
            ...
            else if (choice == 2)
            {
                ...
                {
                    assume msgvalue_MSG == 0;
                    call transfer_Wallet__success(from, to, msgvalue_MSG, to_s75, amt_s75);
                    if (revert)
                    {
                        return;
                    }
            ...
            else if (choice == 1)
            {
                ...
                {
                    assume msgvalue_MSG == 0;
                    call __ret_0_balanceOf := balanceOf_Wallet__success(from, to, msgvalue_MSG, user_s87);
                    if (revert)
                    {
                        return;
                    }
...
implementation CorralChoice_Wallet(this: Ref)
{
  ...
  var tmpNow: int;
    ...
    else if (choice == 2)
    {
        ...
        {
            assume msgvalue_MSG == 0;
            call transfer_Wallet(this, msgsender_MSG, msgvalue_MSG, to_s75, amt_s75);
        }
    }
    else if (choice == 1)
    {
        ...
        {
            assume msgvalue_MSG == 0;
            call __ret_0_balanceOf := balanceOf_Wallet(this, msgsender_MSG, msgvalue_MSG, user_s87);
        }
    }
}
