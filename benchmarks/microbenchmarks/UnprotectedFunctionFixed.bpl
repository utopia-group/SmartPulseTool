...
// Command Line Options: /print:UnprotectedFunctionFixed.bpl /pretty:1 /noVerify __SolToBoogieTest_out.bpl
...
procedure {:public} {:inline 1} newOwner_MultiOwnable(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s64: Ref)
...
implementation newOwner_MultiOwnable(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s64: Ref)
   returns (__ret_0_: bool)
{
  var __exception: bool;
    ...
    if (__exception)
    {
        ...
        __tmp__root_MultiOwnable := root_MultiOwnable;
        __tmp__owners_MultiOwnable := owners_MultiOwnable;
        call __ret_0_ := newOwner_MultiOwnable__fail(this, msgsender_MSG, msgvalue_MSG, _owner_s64);
        assume revert || gas < 0;
    }
    else
    {
        call __ret_0_ := newOwner_MultiOwnable__success(this, msgsender_MSG, msgvalue_MSG, _owner_s64);
        assume !revert && gas >= 0;
    }
}
...
procedure {:public} {:inline 1} deleteOwner_MultiOwnable(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s107: Ref)
   returns (__ret_0_: bool);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_Ref_owners0, __tmp__sum_owners0, __tmp__Length, __tmp__now, __tmp__root_MultiOwnable, __tmp__owners_MultiOwnable, gas, M_Ref_Ref_owners0;



implementation deleteOwner_MultiOwnable(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s107: Ref)
   returns (__ret_0_: bool)
{
  var __exception: bool;
    ...
    if (__exception)
    {
        ...
        __tmp__root_MultiOwnable := root_MultiOwnable;
        __tmp__owners_MultiOwnable := owners_MultiOwnable;
        call __ret_0_ := deleteOwner_MultiOwnable__fail(this, msgsender_MSG, msgvalue_MSG, _owner_s107);
        assume revert || gas < 0;
    }
    else
    {
        call __ret_0_ := deleteOwner_MultiOwnable__success(this, msgsender_MSG, msgvalue_MSG, _owner_s107);
        assume !revert && gas >= 0;
    }
}
...
procedure {:inline 1} newOwner_MultiOwnable__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s64: Ref)
   returns (__ret_0_: bool);
  modifies gas, revert, M_Ref_Ref_owners0;



procedure {:inline 1} newOwner_MultiOwnable__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s64: Ref)
   returns (__ret_0_: bool);
  modifies gas, revert, __tmp__M_Ref_Ref_owners0;



procedure {:inline 1} deleteOwner_MultiOwnable__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s107: Ref)
   returns (__ret_0_: bool);
  modifies gas, revert, M_Ref_Ref_owners0;



procedure {:inline 1} deleteOwner_MultiOwnable__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s107: Ref)
   returns (__ret_0_: bool);
  modifies gas, revert, __tmp__M_Ref_Ref_owners0;
...
implementation newOwner_MultiOwnable__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s64: Ref)
   returns (__ret_0_: bool)
{
  var __var_3: Ref;
    ...
    gas := gas - 40724;
    __tmp__M_Ref_Ref_owners0[__tmp__owners_MultiOwnable[this]][_owner_s64] := msgsender_MSG;
    gas := gas - 16;
    __ret_0_ := true;
    return;
}
...
implementation newOwner_MultiOwnable__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s64: Ref)
   returns (__ret_0_: bool)
{
  var __var_3: Ref;
    ...
    gas := gas - 40724;
    M_Ref_Ref_owners0[owners_MultiOwnable[this]][_owner_s64] := msgsender_MSG;
    gas := gas - 16;
    __ret_0_ := true;
    return;
}
...
implementation deleteOwner_MultiOwnable__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s107: Ref)
   returns (__ret_0_: bool)
{
  var __var_4: Ref;
  var __var_5: Ref;
    ...
    gas := gas - 2050;
    __var_4 := null;
    if (!(__tmp__M_Ref_Ref_owners0[__tmp__owners_MultiOwnable[this]][_owner_s107]
         == msgsender_MSG
       || (__tmp__M_Ref_Ref_owners0[__tmp__owners_MultiOwnable[this]][_owner_s107] != null
    ...
    gas := gas - 40726;
    __var_5 := null;
    __tmp__M_Ref_Ref_owners0[__tmp__owners_MultiOwnable[this]][_owner_s107] := __var_5;
    gas := gas - 16;
    __ret_0_ := true;
    return;
}
...
implementation deleteOwner_MultiOwnable__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, _owner_s107: Ref)
   returns (__ret_0_: bool)
{
  var __var_4: Ref;
  var __var_5: Ref;
    ...
    gas := gas - 2050;
    __var_4 := null;
    if (!(M_Ref_Ref_owners0[owners_MultiOwnable[this]][_owner_s107] == msgsender_MSG
       || (M_Ref_Ref_owners0[owners_MultiOwnable[this]][_owner_s107] != null
    ...
    gas := gas - 40726;
    __var_5 := null;
    M_Ref_Ref_owners0[owners_MultiOwnable[this]][_owner_s107] := __var_5;
    gas := gas - 16;
    __ret_0_ := true;
    return;
}
        ...
        if (__tmp__DType[from] == TestContract)
        {
            if (choice == 3)
            {
                ...
                if (gas >= 0)
                {
                    ...
                    call __ret_0_newOwner := newOwner_MultiOwnable__fail(from, to, msgvalue_MSG, _owner_s64);
                    if (revert)
                    {
                        return;
                    }
            ...
            else if (choice == 2)
            {
                ...
                {
                    assume msgvalue_MSG == 0;
                    call __ret_0_deleteOwner := deleteOwner_MultiOwnable__fail(from, to, msgvalue_MSG, _owner_s107);
                    if (revert)
                    {
                        return;
                    }
    ...
    while (iterate && gas >= 21000)
    {
        ...
        if (DType[from] == TestContract)
        {
            if (choice == 3)
            {
                ...
                {
                    assume msgvalue_MSG == 0;
                    call __ret_0_newOwner := newOwner_MultiOwnable__success(from, to, msgvalue_MSG, _owner_s64);
                    if (revert)
                    {
                        return;
                    }
            ...
            else if (choice == 2)
            {
                ...
                {
                    assume msgvalue_MSG == 0;
                    call __ret_0_deleteOwner := deleteOwner_MultiOwnable__success(from, to, msgvalue_MSG, _owner_s107);
                    if (revert)
                    {
                        return;
                    }
...
implementation CorralChoice_MultiOwnable(this: Ref)
{
  ...
  var tmpNow: int;
    ...
    if (choice == 2)
    {
        ...
        {
            assume msgvalue_MSG == 0;
            call __ret_0_newOwner := newOwner_MultiOwnable(this, msgsender_MSG, msgvalue_MSG, _owner_s64);
        }
    }
    else if (choice == 1)
    {
        ...
        {
            assume msgvalue_MSG == 0;
            call __ret_0_deleteOwner := deleteOwner_MultiOwnable(this, msgsender_MSG, msgvalue_MSG, _owner_s107);
        }
    }
}
