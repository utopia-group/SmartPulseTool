...
implementation refund_CrowdFund__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  var __var_5: int;
    ...
    assume i_s102 >= 0;
    i_s102 := 0;
    while (i_s102 < __tmp__Length[__tmp__refundAddresses_CrowdFund[this]])
    {
        gas := gas - 37113;
        assume i_s102 >= 0;
        assume __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][__tmp__M_int_Ref[__tmp__refundAddresses_CrowdFund[this]][i_s102]]
           >= 0;
        __var_5 := gas;
        if (gas > 2300)
        {
        ...
        __var_5 := __var_5 - gas;
        assume i_s102 >= 0;
        call __var_4 := send__fail(this, __tmp__M_int_Ref[__tmp__refundAddresses_CrowdFund[this]][i_s102], __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][__tmp__M_int_Ref[__tmp__refundAddresses_CrowdFund[this]][i_s102]]);
        gas := __var_5 + gas;
        if (__var_4)
        {
            gas := gas - 5626;
            ...
            assume __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][__tmp__M_int_Ref[__tmp__refundAddresses_CrowdFund[this]][i_s102]]
               >= 0;
            __tmp__sum_refundAmount0[__tmp__refundAmount_CrowdFund[this]] := __tmp__sum_refundAmount0[__tmp__refundAmount_CrowdFund[this]]
               - __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][__tmp__M_int_Ref[__tmp__refundAddresses_CrowdFund[this]][i_s102]];
            __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][__tmp__M_int_Ref[__tmp__refundAddresses_CrowdFund[this]][i_s102]] := 0;
            __tmp__sum_refundAmount0[__tmp__refundAmount_CrowdFund[this]] := __tmp__sum_refundAmount0[__tmp__refundAmount_CrowdFund[this]]
               + __tmp__M_Ref_int_refundAmount0[__tmp__refundAmount_CrowdFund[this]][__tmp__M_int_Ref[__tmp__refundAddresses_CrowdFund[this]][i_s102]];
        }
...
implementation refund_CrowdFund__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  var __var_5: int;
    ...
    assume i_s102 >= 0;
    i_s102 := 0;
    while (i_s102 < Length[refundAddresses_CrowdFund[this]])
    {
        gas := gas - 37113;
        assume i_s102 >= 0;
        assume M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][M_int_Ref[refundAddresses_CrowdFund[this]][i_s102]]
           >= 0;
        __var_5 := gas;
        if (gas > 2300)
        {
        ...
        __var_5 := __var_5 - gas;
        assume i_s102 >= 0;
        call __var_4 := send__success(this, M_int_Ref[refundAddresses_CrowdFund[this]][i_s102], M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][M_int_Ref[refundAddresses_CrowdFund[this]][i_s102]]);
        gas := __var_5 + gas;
        if (__var_4)
        {
            gas := gas - 5626;
            ...
            assume M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][M_int_Ref[refundAddresses_CrowdFund[this]][i_s102]]
               >= 0;
            sum_refundAmount0[refundAmount_CrowdFund[this]] := sum_refundAmount0[refundAmount_CrowdFund[this]]
               - M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][M_int_Ref[refundAddresses_CrowdFund[this]][i_s102]];
            M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][M_int_Ref[refundAddresses_CrowdFund[this]][i_s102]] := 0;
            sum_refundAmount0[refundAmount_CrowdFund[this]] := sum_refundAmount0[refundAmount_CrowdFund[this]]
               + M_Ref_int_refundAmount0[refundAmount_CrowdFund[this]][M_int_Ref[refundAddresses_CrowdFund[this]][i_s102]];
        }
