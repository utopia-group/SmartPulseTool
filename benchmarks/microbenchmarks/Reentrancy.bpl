...
// Command Line Options: /print:Reentrancy.bpl /pretty:1 /noVerify __SolToBoogieTest_out.bpl
...
procedure {:inline 1} withdraw_SimpleDAO__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, amount_s62: int);
  modifies gas, revert, sum_credit0, M_Ref_int_credit0, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_credit0, __tmp__sum_credit0, __tmp__Length, __tmp__now, __tmp__credit_SimpleDAO, Balance;



procedure {:inline 1} withdraw_SimpleDAO__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int, amount_s62: int);
  modifies gas, revert, __tmp__sum_credit0, __tmp__M_Ref_int_credit0, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__Length, __tmp__now, __tmp__credit_SimpleDAO;
