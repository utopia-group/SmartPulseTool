...
contract MintingCrowdsale is Ownable {
    ...
    function super_distributeTokensViaPublicSale(
      address[] memory beneficiaries,
      uint[] memory amounts
    )
      internal
    {
      distributeTokensViaPublicSale(beneficiaries, amounts);
    }
    ...
    function super_distributeTokensViaPrivateSale(
      address[] memory beneficiaries,
      uint[] memory amounts
    )
      internal
    {
      distributeTokensViaPrivateSale(beneficiaries, amounts);
    }
    ...
    function super_finalize() internal {
      finalize();
    }
    ...
    function super_forwardFunds() internal {
      forwardFunds();
    }
...
contract StokrCrowdsale is MintingCrowdsale {
    ...
    function distributeTokensViaPublicSale(
        ...
        public
    {
        super_distributeTokensViaPublicSale(beneficiaries, amounts);
    ...
    function distributeTokensViaPrivateSale(
        ...
        public
    {
        super_distributeTokensViaPrivateSale(beneficiaries, amounts);
        // The goal may get reached due to token distribution,
        // so forward any accumulated funds to the company wallet.
        forwardFunds();
    }
