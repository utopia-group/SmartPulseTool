...
// Command Line Options: /print:SimpleAuction-tmp.bpl /pretty:1 /noVerify __SolToBoogieTest_out.bpl
...
var SimpleAuction: ContractName;
...
procedure {:public} {:inline 1} withdraw_SimpleAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int) returns (__ret_0_: bool);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_pendingReturns0, __tmp__sum_pendingReturns0, __tmp__Length, __tmp__now, __tmp__auctionStart_SimpleAuction, __tmp__biddingTime_SimpleAuction, __tmp__highestBidder_SimpleAuction, __tmp__highestBid_SimpleAuction, __tmp__pendingReturns_SimpleAuction, __tmp__ended_SimpleAuction, __tmp___beneficiary_SimpleAuction, __tmp__beneficiary_SimpleAuction, gas, sum_pendingReturns0, M_Ref_int_pendingReturns0, Balance, highestBidder_SimpleAuction, highestBid_SimpleAuction, ended_SimpleAuction;
...
procedure {:public} {:inline 1} auctionEnd_SimpleAuction(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int);
  modifies revert, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_pendingReturns0, __tmp__sum_pendingReturns0, __tmp__Length, __tmp__now, __tmp__auctionStart_SimpleAuction, __tmp__biddingTime_SimpleAuction, __tmp__highestBidder_SimpleAuction, __tmp__highestBid_SimpleAuction, __tmp__pendingReturns_SimpleAuction, __tmp__ended_SimpleAuction, __tmp___beneficiary_SimpleAuction, __tmp__beneficiary_SimpleAuction, gas, ended_SimpleAuction, Balance, sum_pendingReturns0, M_Ref_int_pendingReturns0, highestBidder_SimpleAuction, highestBid_SimpleAuction;
...
procedure {:inline 1} FallbackDispatch__success(from: Ref, to: Ref, amount: int);
  modifies Balance, revert, gas, sum_pendingReturns0, M_Ref_int_pendingReturns0, highestBidder_SimpleAuction, highestBid_SimpleAuction, __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_pendingReturns0, __tmp__sum_pendingReturns0, __tmp__Length, __tmp__now, __tmp__auctionStart_SimpleAuction, __tmp__biddingTime_SimpleAuction, __tmp__highestBidder_SimpleAuction, __tmp__highestBid_SimpleAuction, __tmp__pendingReturns_SimpleAuction, __tmp__ended_SimpleAuction, __tmp___beneficiary_SimpleAuction, __tmp__beneficiary_SimpleAuction, ended_SimpleAuction;
...
procedure {:inline 1} FallbackDispatch__fail(from: Ref, to: Ref, amount: int);
  modifies __tmp__Balance, revert, gas, __tmp__sum_pendingReturns0, __tmp__M_Ref_int_pendingReturns0, __tmp__highestBidder_SimpleAuction, __tmp__highestBid_SimpleAuction, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__Length, __tmp__now, __tmp__auctionStart_SimpleAuction, __tmp__biddingTime_SimpleAuction, __tmp__pendingReturns_SimpleAuction, __tmp__ended_SimpleAuction, __tmp___beneficiary_SimpleAuction, __tmp__beneficiary_SimpleAuction;
...
procedure {:inline 1} send__fail(from: Ref, to: Ref, amount: int) returns (success: bool);
  modifies __tmp__Balance, __tmp__DType, __tmp__Alloc, __tmp__balance_ADDR, __tmp__M_Ref_int_pendingReturns0, __tmp__sum_pendingReturns0, __tmp__Length, __tmp__now, __tmp__auctionStart_SimpleAuction, __tmp__biddingTime_SimpleAuction, __tmp__highestBidder_SimpleAuction, __tmp__highestBid_SimpleAuction, __tmp__pendingReturns_SimpleAuction, __tmp__ended_SimpleAuction, __tmp___beneficiary_SimpleAuction, __tmp__beneficiary_SimpleAuction, revert, gas;
...
implementation Fallback_UnknownType__fail(from: Ref, to: Ref, amount: int)
{
  ...
  var __ret_0_auctionEndTime: int;
    ...
    if (__tmp__DType[from] == SimpleAuction)
    {
        if (choice == 4)
        {
            gas := gas - 21000;
            ...
            {
                assume msgvalue_MSG >= 0;
                call bid_SimpleAuction__fail(from, to, msgvalue_MSG);
                if (revert)
                {
                    return;
                }
        ...
        else if (choice == 3)
        {
            ...
            {
                assume msgvalue_MSG == 0;
                call __ret_0_withdraw := withdraw_SimpleAuction__fail(from, to, msgvalue_MSG);
                if (revert)
                {
                    return;
                }
        ...
        else if (choice == 2)
        {
            ...
            {
                assume msgvalue_MSG == 0;
                call __ret_0_auctionEndTime := auctionEndTime_SimpleAuction__fail(from, to, msgvalue_MSG);
                if (revert)
                {
                    return;
                }
        ...
        else if (choice == 1)
        {
            ...
            {
                assume msgvalue_MSG == 0;
                call auctionEnd_SimpleAuction__fail(from, to, msgvalue_MSG);
                if (revert)
                {
                    return;
                }
  ...
  var __ret_0_auctionEndTime: int;
    ...
    if (DType[from] == SimpleAuction)
    {
        if (choice == 4)
        {
            ...
            {
                assume msgvalue_MSG >= 0;
                call bid_SimpleAuction__success(from, to, msgvalue_MSG);
                if (revert)
                {
                    return;
                }
        ...
        else if (choice == 3)
        {
            ...
            {
                assume msgvalue_MSG == 0;
                call __ret_0_withdraw := withdraw_SimpleAuction__success(from, to, msgvalue_MSG);
                if (revert)
                {
                    return;
                }
        ...
        else if (choice == 2)
        {
            ...
            {
                assume msgvalue_MSG == 0;
                call __ret_0_auctionEndTime := auctionEndTime_SimpleAuction__success(from, to, msgvalue_MSG);
                if (revert)
                {
                    return;
                }
        ...
        else if (choice == 1)
        {
            ...
            {
                assume msgvalue_MSG == 0;
                call auctionEnd_SimpleAuction__success(from, to, msgvalue_MSG);
                if (revert)
                {
                    return;
                }
