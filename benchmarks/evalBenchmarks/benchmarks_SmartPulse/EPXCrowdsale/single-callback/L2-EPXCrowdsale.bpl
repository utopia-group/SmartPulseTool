...
implementation EPXCrowdsale_EPXCrowdsale_NoBaseCtor__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  var __var_2: Ref;
    ...
    __tmp__CurrentStatus_EPXCrowdsale[this] := -779175998;
    ...
    __tmp__CurrentStatus_EPXCrowdsale[this] := 305526541;
}
...
implementation EPXCrowdsale_EPXCrowdsale_NoBaseCtor__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
  ...
  var __var_2: Ref;
    ...
    CurrentStatus_EPXCrowdsale[this] := -779175998;
    ...
    CurrentStatus_EPXCrowdsale[this] := 305526541;
}
   ...
   returns (response_s391: int)
{
  ...
  var __var_8: Ref;
       ...
       && !(__tmp__beneficiaryWallet_EPXCrowdsale[this] > null))
    {
        ...
        __tmp__isCrowdSaleClosed_EPXCrowdsale[this] := false;
        gas := gas - 409;
        __tmp__CurrentStatus_EPXCrowdsale[this] := -83871603;
        gas := gas - 19;
        response_s391 := -83871603;
        return;
    }
    else
    {
        ...
        {
            gas := gas - 19;
            response_s391 := -1715270973;
            return;
        }
        else
        {
            gas := gas - 8;
            response_s391 := -1451351387;
            return;
        }
    }
}
   ...
   returns (response_s391: int)
{
  ...
  var __var_8: Ref;
       ...
       && !(beneficiaryWallet_EPXCrowdsale[this] > null))
    {
        ...
        isCrowdSaleClosed_EPXCrowdsale[this] := false;
        gas := gas - 409;
        CurrentStatus_EPXCrowdsale[this] := -83871603;
        gas := gas - 19;
        response_s391 := -83871603;
        return;
    }
...
implementation checkGoalReached_EPXCrowdsale__fail(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
       ...
       && __tmp__now >= __tmp__fundingStartBlock_EPXCrowdsale[this])
    {
        ...
        __tmp__isCrowdSaleClosed_EPXCrowdsale[this] := false;
        gas := gas - 398;
        __tmp__CurrentStatus_EPXCrowdsale[this] := -880273060;
    }
    else
    {
        gas := gas - 639;
        ...
        else
        {
               ...
               && __tmp__now > __tmp__fundingEndBlock_EPXCrowdsale[this])
            {
                ...
                gas := gas - 409;
                __tmp__CurrentStatus_EPXCrowdsale[this] := -100129202;
            }
            else
            {
                gas := gas - 643;
                   ...
                   && __tmp__tokensRemaining_EPXCrowdsale[this] == 0)
                {
                    ...
                    __tmp__isCrowdSaleClosed_EPXCrowdsale[this] := true;
                    gas := gas - 409;
                    __tmp__CurrentStatus_EPXCrowdsale[this] := 299498758;
                }
                else
                {
                    gas := gas - 873;
                       ...
                       && __tmp__tokensRemaining_EPXCrowdsale[this] > 0)
                    {
                        ...
                        __tmp__isCrowdSaleClosed_EPXCrowdsale[this] := true;
                        gas := gas - 409;
                        __tmp__CurrentStatus_EPXCrowdsale[this] := -349424081;
                    }
                    else
                    {
                        gas := gas - 876;
                           ...
                           && __tmp__now <= __tmp__fundingEndBlock_EPXCrowdsale[this])
                        {
                            ...
                            __tmp__isCrowdSaleClosed_EPXCrowdsale[this] := false;
                            gas := gas - 409;
                            __tmp__CurrentStatus_EPXCrowdsale[this] := -145992971;
                        }
                    }
                }
            }
...
implementation checkGoalReached_EPXCrowdsale__success(this: Ref, msgsender_MSG: Ref, msgvalue_MSG: int)
{
       ...
       && now >= fundingStartBlock_EPXCrowdsale[this])
    {
        ...
        isCrowdSaleClosed_EPXCrowdsale[this] := false;
        gas := gas - 398;
        CurrentStatus_EPXCrowdsale[this] := -880273060;
    }
    else
    {
        gas := gas - 639;
        ...
        else
        {
               ...
               && now > fundingEndBlock_EPXCrowdsale[this])
            {
                ...
                gas := gas - 409;
                CurrentStatus_EPXCrowdsale[this] := -100129202;
            }
            else
            {
                gas := gas - 643;
                   ...
                   && tokensRemaining_EPXCrowdsale[this] == 0)
                {
                    ...
                    isCrowdSaleClosed_EPXCrowdsale[this] := true;
                    gas := gas - 409;
                    CurrentStatus_EPXCrowdsale[this] := 299498758;
                }
                else
                {
                    gas := gas - 873;
                       ...
                       && tokensRemaining_EPXCrowdsale[this] > 0)
                    {
                        ...
                        isCrowdSaleClosed_EPXCrowdsale[this] := true;
                        gas := gas - 409;
                        CurrentStatus_EPXCrowdsale[this] := -349424081;
                    }
                    else
                    {
                        gas := gas - 876;
                           ...
                           && now <= fundingEndBlock_EPXCrowdsale[this])
                        {
                            ...
                            isCrowdSaleClosed_EPXCrowdsale[this] := false;
                            gas := gas - 409;
                            CurrentStatus_EPXCrowdsale[this] := -145992971;
                        }
                    }
                }
            }
