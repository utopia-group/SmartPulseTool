...
public abstract class CodeBlock extends IcfgEdge {
	...
	protected String mPrecedingProcedure;
	protected String mSucceedingProcedure;

	protected RCFGEdgeAnnotation mAnnotation;

	private int mOccurenceInCounterexamples = 0;

	protected CodeBlock(final int serialNumber, final BoogieIcfgLocation source, final BoogieIcfgLocation target,
