...
import edu.utexas.cs.utopia.specLang.preferences.PreferenceInitializer;
 ...
 */
public class UtopiaSpecLang implements IGenerator, ISource {
	...
	private UtopiaSpecLangObserver mObserver;
	private IUltimateServiceProvider mServices;
	private IToolchainStorage mStorage;
	private final String[] mFileTypes;
	private ILogger mLogger;

	public UtopiaSpecLang() {
	...
	public List<IObserver> getObservers() {
		mObserver = new UtopiaSpecLangObserver(mServices, mStorage);
