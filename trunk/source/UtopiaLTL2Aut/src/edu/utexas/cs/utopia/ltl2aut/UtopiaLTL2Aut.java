...
import edu.utexas.cs.utopia.ltl2aut.preferences.PreferenceInitializer;
 ...
 */
public class UtopiaLTL2Aut implements IGenerator, ISource {
	...
	private UtopiaLTL2AutObserver mObserver;
	private IUltimateServiceProvider mServices;
	private IToolchainStorage mStorage;
	private final String[] mFileTypes;
	private ILogger mLogger;

	public UtopiaLTL2Aut() {
	...
	public void init() {
		mProcess = false;
		mUseful = 0;
		mObserver = new UtopiaLTL2AutObserver(mServices, mStorage);
	}
	...
	public void setInputDefinition(final ModelType graphType) {
		...
		case "edu.utexas.cs.utopia.specLang":
			mProcess = true;
			mUseful++;
			break;
		default:
