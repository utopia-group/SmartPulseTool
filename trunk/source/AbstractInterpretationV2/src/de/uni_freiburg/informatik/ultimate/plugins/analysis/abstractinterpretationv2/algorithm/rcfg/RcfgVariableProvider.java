 ...
 * @param <STATE>
 */
public class RcfgVariableProvider<STATE extends IAbstractState<STATE>, ACTION extends IcfgEdge> implements IVariableProvider<STATE, ACTION> {
	...
	@Override
	public STATE defineVariablesAfter(final ACTION action, final STATE localPreState,
	...
	private Set<IProgramVarOrConst> getPreVariables(final ACTION current) {
