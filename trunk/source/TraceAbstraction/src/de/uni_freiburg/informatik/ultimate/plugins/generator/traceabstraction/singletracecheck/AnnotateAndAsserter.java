...
public class AnnotateAndAsserter {
	...
	protected NestedWord<? extends IAction> mTrace;
	...
	public void buildAnnotatedSsaAndAssertTerms() {
		...
		buildAnnotatedSsaAndAssertTerms(0);
	}
	
	public void buildAnnotatedSsaAndAssertTerms(int suffixStart) {
		...
		for (int i = suffixStart; i < mTrace.length(); i++) {
